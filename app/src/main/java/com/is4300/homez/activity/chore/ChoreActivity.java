...
public class ChoreActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        modelItems[0] = new ChoreModel("Clean Room", 0, new SimpleDateFormat("1/1/1"), new Roommate("Ian", "Leonard", "ian.leonard44@gmail.com"));
        modelItems[1] = new ChoreModel("Empty Dishwasher", 1, new SimpleDateFormat("1/1/1"), new Roommate("Ian", "Leonard", "ian.leonard44@gmail.com"));
        modelItems[2] = new ChoreModel("Swab the Poopdeck", 1, new SimpleDateFormat("1/1/1"), new Roommate("Ian", "Leonard", "ian.leonard44@gmail.com"));
        modelItems[3] = new ChoreModel("Buy Toilet Paper", 0, new SimpleDateFormat("1/1/1"), new Roommate("Ian", "Leonard", "ian.leonard44@gmail.com"));
        modelItems[4] = new ChoreModel("Take Out Trash", 1, new SimpleDateFormat("1/1/1"), new Roommate("Ian", "Leonard", "ian.leonard44@gmail.com"));
